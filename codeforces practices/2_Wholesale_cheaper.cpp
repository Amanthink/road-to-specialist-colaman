...
void solve() {
    ...
    long long orangeBoxes = (n + k - 1) / k;
    long long appleBoxes  = (m + k - 1) / k;

    long long minCost = (orangeBoxes + appleBoxes) * p;
    ...
    long long packs = (orangeBoxes + appleBoxes) * k;

    long long rem = s - minCost;
